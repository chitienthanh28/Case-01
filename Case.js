...
function addValueStaff() {
  ...
  const valueProductSalary = document.getElementById("InputProductSalary").value;
  const valueProductQuantity = document.getElementById("InputProductQuantity").value;
  if (
    valueFullName === "" ||
    valueBaseSalary === "" ||
    valueProductSalary === "" ||
